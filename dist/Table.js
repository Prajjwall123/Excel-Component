...
function Table(props) {
  ...
  var isToggleButton = props.isToggleButton;
  ...
  (0, _react.useEffect)(function () {
    var savedTheme = localStorage.getItem("darkTheme") === "true";
    setIsDarkMode(savedTheme);
    document.body.classList.toggle("dark-theme", savedTheme);
  }, []);
  var _useState5 = (0, _react.useState)({}),
    _useState6 = _slicedToArray(_useState5, 2),
    inputField = _useState6[0],
    setInputField = _useState6[1];
  ...
  }, isToggleButton && /*#__PURE__*/_react["default"].createElement(_reactToggleButton["default"], {
    className: "p-3",
    value: isDarkMode,
    thumbStyle: {
      borderRadius: 2
